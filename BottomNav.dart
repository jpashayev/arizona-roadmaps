...
Widget bottomNav(BuildContext context, bool _visible, final _scaffoldKey, String page, SearchPage search) {
        ...
        IconButton(
          ...
          onPressed: () {
            if(page != "third")
              Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => CampsitePage(search))
              );
            else
              Navigator.pop(context);
          },
